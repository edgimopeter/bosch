		...
		foreach($this->errors as $e) {
			...
			switch($e['rule']) {
				...
				case 'validate_max_len':
					if($param == 1) {
						$resp[$e['field']] = "The <span class=\"$field_class\">$field</span> field needs to be shorter than $param character";
					} else {
						$resp[$e['field']] = "The <span class=\"$field_class\">$field</span> field needs to be shorter than $param characters";
					}
					break;
				case 'validate_min_len':
					if($param == 1) {
						$resp[$e['field']] = "The <span class=\"$field_class\">$field</span> field needs to be longer than $param character";
					} else {
						$resp[$e['field']] = "The <span class=\"$field_class\">$field</span> field needs to be longer than $param characters";
					}
					break;
				case 'validate_exact_len':
					if($param == 1) {
						$resp[$e['field']] = "The <span class=\"$field_class\">$field</span> field needs to be exactly $param character in length";
					} else {
				...
				case 'validate_contains':
					$resp[$e['field']] = "The <span class=\"$field_class\">$field</span> field needs contain one of these values: ".implode(', ', $param);
					break;
